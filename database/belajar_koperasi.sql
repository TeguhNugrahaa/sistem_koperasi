...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2023 at 04:44 AM
...
CREATE TABLE `anggota` (
  `anggota_id` int(30) NOT NULL,
  `anggota_nama` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_alamat` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_tempat` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_tanggal` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_handphone` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_email` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_pekerjaan` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_tanggungan` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_ktp` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_npwp` varchar(150) CHARACTER SET utf8 NOT NULL,
  `anggota_bukti` varchar(150) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `anggota` (`anggota_id`, `anggota_nama`, `anggota_alamat`, `anggota_tempat`, `anggota_tanggal`, `anggota_handphone`, `anggota_email`, `anggota_pekerjaan`, `anggota_tanggungan`, `anggota_ktp`, `anggota_npwp`, `anggota_bukti`) VALUES
(1, 'Teguh Nugraha', 'Matraman', 'Serang', '', '085262272727', 'nugraha@gmail.com', 'Tukang Sayur', '0', 'belajar buat slider.jpg', 'tampilan pre test and post test mini mba.png', 'tampilan pre test and post test mini mba.png');
...
CREATE TABLE `pinjaman` (
  `pinjaman_id` int(100) NOT NULL,
  `kode_pinjam` int(100) NOT NULL,
  `nama_anggota` varchar(100) NOT NULL,
  `tanggal_pinjam` date NOT NULL,
  `tanggal_tempo` date NOT NULL,
  `jenis_pinjam` enum('Konsumtif','Produktif','Investasi','Mikro') NOT NULL,
  `besar_pinjam` varchar(100) NOT NULL,
  `lama_angsuran` varchar(100) NOT NULL,
  `status_pinjaman` enum('Lunas','Nyicil') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pinjaman` (`pinjaman_id`, `kode_pinjam`, `nama_anggota`, `tanggal_pinjam`, `tanggal_tempo`, `jenis_pinjam`, `besar_pinjam`, `lama_angsuran`, `status_pinjaman`) VALUES
(1, 123, 'Nugrah2', '2023-03-20', '2023-03-27', 'Produktif', '5000', '4 bulan', 'Lunas'),
(2, 456, 'Ahmad Baehaki Manurung', '2023-03-19', '2023-03-27', 'Produktif', '4000', '3 bulan', 'Nyicil'),
(3, 1234567, 'Ahmad Kosasih Manurung', '2023-03-20', '2023-03-27', 'Produktif', '5000', '3 bulan', 'Nyicil');
...
CREATE TABLE `simpanan` (
  `simpanan_id` int(100) NOT NULL,
  `kode_simpanan` varchar(250) NOT NULL,
  `jenis_simpanan` enum('Pokok','Wajib','Sukarela') NOT NULL,
  `besar_simpanan` varchar(250) NOT NULL,
  `kode_anggota` int(250) NOT NULL,
...
INSERT INTO `simpanan` (`simpanan_id`, `kode_simpanan`, `jenis_simpanan`, `besar_simpanan`, `kode_anggota`, `tanggal_masuk`) VALUES
(1, '123', 'Sukarela', '1000', 1234, '2023-03-25');
...
CREATE TABLE `tabungan` (
  `tabungan_id` int(100) NOT NULL,
  `kode_tabungan` varchar(100) NOT NULL,
  `anggota_tabungan` varchar(100) NOT NULL,
  `tabungan_tanggal` date NOT NULL,
...
INSERT INTO `tabungan` (`tabungan_id`, `kode_tabungan`, `anggota_tabungan`, `tabungan_tanggal`, `saldo`, `rekening_bank`) VALUES
(1, '123', 'Safrudin Nugraha', '2023-03-28', 5000, 'Mayapada'),
(3, '456', 'Ahmad Kosasih Manurung', '2023-03-21', 5000, 'BCA');
...
(16, 'Teguh Nugraha', '', 'd41d8cd98f00b204e9800998ecf8427e', '', 'aktif'),
(17, 'Teguh Nugraha', '', 'd41d8cd98f00b204e9800998ecf8427e', '1689934707_gambar pre test cicrm (1).png', 'mati'),
(18, 'julkifli', '', 'd41d8cd98f00b204e9800998ecf8427e', '114886595_tampilan pre test and post test mini mba.png', 'aktif'),
(19, 'safrudin', '', 'd41d8cd98f00b204e9800998ecf8427e', '2138184485_tampilan pre test and post test mini mba.png', 'aktif'),
(20, '455678', 'tanjung', 'karyawan 2', '', 'mati'),
(21, '1234', 'jamhuri', '123', '', 'mati'),
(22, '4556789', 'sherly', 'staff it', '', 'aktif');
...
--
ALTER TABLE `anggota`
  MODIFY `anggota_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pensiun`
  MODIFY `id_pensiun` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `pinjaman`
--
ALTER TABLE `pinjaman`
  MODIFY `pinjaman_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `simpanan`
  MODIFY `simpanan_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tabungan`
--
ALTER TABLE `tabungan`
  MODIFY `tabungan_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
