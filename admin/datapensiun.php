            ...
            <section class="col-lg-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sekarang" required="required" class="form-control" placeholder="Masukkan Umur Sekarang ..">
                                            </div>


                                            <div class="form-group">
                                                <label>Umur Pensiun</label>
                                                <input type="text" name="pensiun" required="required" class="form-control" placeholder="Masukkan Umur Pensiun ..">
                                            </div>


                                            <div class="form-group">
                                                <label>Jumlah Waktu Sisa</label>
                                                <input type="text" name="sisa" required="required" class="form-control" placeholder="Masukkan Jumlah waktu sisa ..">
                                            </div>

                                            <div class="form-group">
                                                <label>Biaya berdua saat ini</label>
                                                <input type="text" name="berdua" required="required" class="form-control" placeholder="Masukkan biaya berdua saat ini ..">
                                            </div>

                                            <div class="form-group">
                                                <label>Asumsi Inflasi (%)</label>
                                                <input type="text" name="asumsi" required="required" class="form-control" placeholder="Masukkan asumsi inflasi ..">
                                            </div>


                                            <div class="form-group">
                                                <label>Biaya saat pensiun</label>
                                                <input type="text" name="biaya" required="required" class="form-control" placeholder="Masukkan Biaya saat pensiun ..">
                                            </div>


                                            <div class="form-group">
                                                <label>Bunga Deposito Waktu Pensiun (%)</label>
                                                <input type="text" name="bunga" required="required" class="form-control" placeholder="Masukkan Bunga Deposito waktu pensiun ..">
                                            </div>

                                            <div class="form-group">
                                                <label>Total Dana Persiapan pensiun</label>
                                                <input type="text" name="total" required="required" class="form-control" placeholder="Masukkan Total Dana Persiapan pensiun ..">
                                            </div>

                                            <div class="form-group">
                                                <label>Return Investasi periode kerja (%)</label>
                                                <input type="text" name="return" required="required" class="form-control" placeholder="Masukkan Return Investasi periode kerja ..">
                                            </div>


                                            <div class="form-group">
                                                <label>Simpanan periode kerja</label>
                                                <input type="text" name="simpan" required="required" class="form-control" placeholder="Masukkan Simpanan periode kerja ..">
                                            </div>
                        ...
                        <a href="lap_excel_pensiun.php?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-excel-o"></i> &nbsp CETAK EXCEL FORMULA</a>
