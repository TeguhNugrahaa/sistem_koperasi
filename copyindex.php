...
<head>
    ...
    <title>Sistem Informasi Koperasi MCI</title>
    ...
    <div class="container">
        <div class="login-box">
            ...
            <center>
                ...
                <h2>SISTEM INFORMASI KOPERASI MCI</h2>
            ...
            <div class="login-box-body">
                ...
                <center>
                    ...
                    <!-- Logo Koperasi -->
                    <i class="fa fa-handshake-o" aria-hidden="" style="font-size: 130px"></i>


                    <!--i class="fa fa-money text-success" style="font-size: 130px"></i>-->
                </center>
                ...
                <form action="periksa_login.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-8 col-xs-4">
                            ...
                            <footer>Tidak Punya Akun? <a href="register.php">Daftar Dulu!</a></footer>
                        </div>
                    </div>
