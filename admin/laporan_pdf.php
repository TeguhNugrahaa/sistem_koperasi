...
$pdf->Cell(100, 7, 'JENIS', 1, 0, 'C');
$pdf->Cell(1, 7, '', 0, 1);
$pdf->Cell(195, 7, '', 0, 0);
$pdf->Cell(50, 7, 'PEMASUKAN', 1, 0, 'C');
$pdf->Cell(50, 7, 'PENGELUARAN', 1, 1, 'C');
...
while ($d = mysqli_fetch_array($data)) {
  ...
  $pdf->Cell(180, 7, $d['transaksi_keterangan'], 1, 0, 'C');
  ...
  $pdf->Cell(30, 7, $pem, 1, 0, 'C');
  $pdf->Cell(30, 7, $peng, 1, 1, 'C');
  $pdf->Cell(10, 0, '', 0, 1);
}
...
$pdf->Cell(150, 7, "SALDO", 1, 0, 'R');
$pdf->Cell(50, 7, "Rp. " . number_format($total_pemasukan - $total_pengeluaran) . " ,-", 1, 0, 'C');
