  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-10">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Rekap Transaksi Pemasukan & Pengeluaran </h3>
          </div>
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan-excel.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-excel-o"></i> &nbsp CETAK EXCEL</a>
